...
static void ForEachCB_PopulateOutfitOverworlds(u32 idx, u32 col, u32 row)
{
    ...
    sOutfitMenu->grid->iconSpriteIds[idx] = AddPseudoObjectEvent(gfx, SpriteCB_Overworld, x, y, 1);
...
static void UpdateCursorPosition(void)
{
    ...
    gSprites[sOutfitMenu->spriteIds[GFX_CURSOR]].pos1.x = x;
    gSprites[sOutfitMenu->spriteIds[GFX_CURSOR]].pos1.y = y;
}
