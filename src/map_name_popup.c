...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_LAKE_MEAD_VILLAGE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_JAGOW_WAY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_WALMORE_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_JAGOW_WOODS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_MEAD - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SUMMIT_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE
};
